...
- 后端：Go + Fiber，详细见 [nimbus-blog-api/README.md](nimbus-blog-api/README.md)
- 前端：Next.js App Router，详细见 [nimbus-blog-web/README.md](nimbus-blog-web/README.md)
...
- 后端本地开发：[nimbus-blog-api/README.md](nimbus-blog-api/README.md)
- 前端本地开发：[nimbus-blog-web/README.md](nimbus-blog-web/README.md)
...
前端环境变量与构建要求见：[nimbus-blog-web/README.md](nimbus-blog-web/README.md)
